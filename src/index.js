import offlineExactMatchDataSet from "./datasets/offlineExactMatchDataSet.js";
import shortHandTextDataSet from "./datasets/shortHandTextDataSet.js";

let canSpellcheck = true;
let spellchecker = null; // spellchecker is an optional dependency package

canSpellcheck = false;

export default new TextAutoCorrector();
...
function TextAutoCorrector_ShortHandText() {
    const map = shortHandTextDataSet;
...
function TextAutoCorrector_offlineExactMatch() {
    ...
    const list = offlineExactMatchDataSet;
